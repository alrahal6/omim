...
EXPECTED_PERMISSIONS = {
    ...
    "permission: com.mapsrahal.maps.pro.permission.C2D_MESSAGE",
    "uses-permission: com.mapsrahal.maps.pro.permission.C2D_MESSAGE",
    "uses-permission: android.permission.VIBRATE",
    "permission: com.mapsrahal.maps.pro.permission.RECEIVE_ADM_MESSAGE",
    "uses-permission: com.mapsrahal.maps.pro.permission.RECEIVE_ADM_MESSAGE",
