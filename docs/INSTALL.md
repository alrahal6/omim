...
of all released versions of data at [direct.mapsrahal.com](http://direct.mapsrahal.com/direct/).
...
* For MAPS.ME employees, publish planet data to http://designer.mapsrahal.com/mac/DATA_VERSION
...
* To enable logging in case of crashes, after installing a debug version, run:
        adb shell pm grant com.mapsrahal.maps.pro.debug android.permission.READ_LOGS
...
application would work well with [downloaded maps](http://direct.mapsrahal.com/direct/latest/),
