...
import com.mapsrahal.maps.ads.MwmNativeAd;
import com.mapsrahal.maps.ads.NativeAdError;
...
import static com.mapsrahal.util.BatteryState.CHARGING_STATUS_PLUGGED;
import static com.mapsrahal.util.BatteryState.CHARGING_STATUS_UNKNOWN;
import static com.mapsrahal.util.BatteryState.CHARGING_STATUS_UNPLUGGED;
import static com.mapsrahal.util.statistics.Statistics.EventName.APPLICATION_COLD_STARTUP_INFO;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_GUIDES_DOWNLOADDIALOGUE_CLICK;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_RESTORE_PROPOSAL_CLICK;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_RESTORE_PROPOSAL_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_RESTORE_PROPOSAL_SUCCESS;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_SYNC_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_SYNC_PROPOSAL_APPROVED;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_SYNC_PROPOSAL_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_SYNC_PROPOSAL_SHOWN;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_SYNC_PROPOSAL_TOGGLE;
import static com.mapsrahal.util.statistics.Statistics.EventName.BM_SYNC_SUCCESS;
import static com.mapsrahal.util.statistics.Statistics.EventName.DOWNLOADER_DIALOG_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.GUIDES_BOOKMARK_SELECT;
import static com.mapsrahal.util.statistics.Statistics.EventName.GUIDES_SHOWN;
import static com.mapsrahal.util.statistics.Statistics.EventName.GUIDES_OPEN;
import static com.mapsrahal.util.statistics.Statistics.EventName.GUIDES_TRACK_SELECT;
import static com.mapsrahal.util.statistics.Statistics.EventName.INAPP_PURCHASE_PREVIEW_SELECT;
import static com.mapsrahal.util.statistics.Statistics.EventName.INAPP_PURCHASE_PREVIEW_SHOW;
import static com.mapsrahal.util.statistics.Statistics.EventName.INAPP_PURCHASE_PRODUCT_DELIVERED;
import static com.mapsrahal.util.statistics.Statistics.EventName.INAPP_PURCHASE_STORE_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.INAPP_PURCHASE_VALIDATION_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_BANNER_BLANK;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_BANNER_CLOSE;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_BANNER_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_BANNER_SHOW;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_OWNERSHIP_BUTTON_CLICK;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_SPONSORED_BOOK;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_SPONSORED_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_SPONSORED_OPEN;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_SPONSORED_SHOWN;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_SPONSOR_ITEM_SELECTED;
import static com.mapsrahal.util.statistics.Statistics.EventName.ROUTING_PLAN_TOOLTIP_CLICK;
import static com.mapsrahal.util.statistics.Statistics.EventName.ROUTING_ROUTE_FINISH;
import static com.mapsrahal.util.statistics.Statistics.EventName.ROUTING_ROUTE_START;
import static com.mapsrahal.util.statistics.Statistics.EventName.SEARCH_FILTER_CLICK;
import static com.mapsrahal.util.statistics.Statistics.EventName.TIPS_TRICKS_CLOSE;
import static com.mapsrahal.util.statistics.Statistics.EventName.TOOLBAR_CLICK;
import static com.mapsrahal.util.statistics.Statistics.EventName.TOOLBAR_MENU_CLICK;
import static com.mapsrahal.util.statistics.Statistics.EventName.UGC_AUTH_ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventName.UGC_AUTH_EXTERNAL_REQUEST_SUCCESS;
import static com.mapsrahal.util.statistics.Statistics.EventName.UGC_AUTH_SHOWN;
import static com.mapsrahal.util.statistics.Statistics.EventName.UGC_REVIEW_START;
import static com.mapsrahal.util.statistics.Statistics.EventParam.ACTION;
import static com.mapsrahal.util.statistics.Statistics.EventParam.BANNER;
import static com.mapsrahal.util.statistics.Statistics.EventParam.BATTERY;
import static com.mapsrahal.util.statistics.Statistics.EventParam.BUTTON;
import static com.mapsrahal.util.statistics.Statistics.EventParam.CATEGORY;
import static com.mapsrahal.util.statistics.Statistics.EventParam.CHARGING;
import static com.mapsrahal.util.statistics.Statistics.EventParam.COUNT_LOWERCASE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.DESTINATION;
import static com.mapsrahal.util.statistics.Statistics.EventParam.ERROR;
import static com.mapsrahal.util.statistics.Statistics.EventParam.ERROR_CODE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.ERROR_MESSAGE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.FEATURE_ID;
import static com.mapsrahal.util.statistics.Statistics.EventParam.FROM;
import static com.mapsrahal.util.statistics.Statistics.EventParam.HAS_AUTH;
import static com.mapsrahal.util.statistics.Statistics.EventParam.HOTEL;
import static com.mapsrahal.util.statistics.Statistics.EventParam.HOTEL_LAT;
import static com.mapsrahal.util.statistics.Statistics.EventParam.HOTEL_LON;
import static com.mapsrahal.util.statistics.Statistics.EventParam.INTERRUPTED;
import static com.mapsrahal.util.statistics.Statistics.EventParam.ITEM;
import static com.mapsrahal.util.statistics.Statistics.EventParam.MAP_DATA_SIZE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.METHOD;
import static com.mapsrahal.util.statistics.Statistics.EventParam.MODE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.MWM_NAME;
import static com.mapsrahal.util.statistics.Statistics.EventParam.MWM_VERSION;
import static com.mapsrahal.util.statistics.Statistics.EventParam.NETWORK;
import static com.mapsrahal.util.statistics.Statistics.EventParam.OBJECT_LAT;
import static com.mapsrahal.util.statistics.Statistics.EventParam.OBJECT_LON;
import static com.mapsrahal.util.statistics.Statistics.EventParam.OPTION;
import static com.mapsrahal.util.statistics.Statistics.EventParam.PLACEMENT;
import static com.mapsrahal.util.statistics.Statistics.EventParam.PRODUCT;
import static com.mapsrahal.util.statistics.Statistics.EventParam.PROVIDER;
import static com.mapsrahal.util.statistics.Statistics.EventParam.PURCHASE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.RESTAURANT;
import static com.mapsrahal.util.statistics.Statistics.EventParam.RESTAURANT_LAT;
import static com.mapsrahal.util.statistics.Statistics.EventParam.RESTAURANT_LON;
import static com.mapsrahal.util.statistics.Statistics.EventParam.SERVER_ID;
import static com.mapsrahal.util.statistics.Statistics.EventParam.SERVER_IDS;
import static com.mapsrahal.util.statistics.Statistics.EventParam.STATE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.TYPE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.VALUE;
import static com.mapsrahal.util.statistics.Statistics.EventParam.VENDOR;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.BACKUP;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.BICYCLE;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.BOOKING_COM;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.DISK_NO_SPACE;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.FACEBOOK;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.GOOGLE;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.HOLIDAY;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.MAPSME;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.NO_BACKUP;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.OFFSCREEEN;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.OPENTABLE;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.PEDESTRIAN;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.PHONE;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.RESTORE;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.SEARCH_BOOKING_COM;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.TAXI;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.TRAFFIC;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.TRANSIT;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.UNKNOWN;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.VEHICLE;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.MAPSME_GUIDES;
import static com.mapsrahal.util.statistics.Statistics.ParamValue.PARTNER;
