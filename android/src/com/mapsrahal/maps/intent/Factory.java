...
import com.mapsrahal.maps.api.Const;
import com.mapsrahal.maps.api.ParsedMwmRequest;
import com.mapsrahal.maps.api.ParsedRoutingData;
import com.mapsrahal.maps.api.ParsedSearchRequest;
import com.mapsrahal.maps.api.ParsedUrlMwmRequest;
import com.mapsrahal.maps.api.RoutePoint;
...
import com.mapsrahal.maps.bookmarks.BookmarksPageFactory;
...
import com.mapsrahal.maps.ugc.EditParams;
import com.mapsrahal.maps.ugc.UGC;
import com.mapsrahal.maps.ugc.UGCEditorActivity;
...
import com.mapsrahal.util.concurrency.ThreadPool;
...
public class Factory
{
  ...
  private static class OldLeadUrlIntentProcessor extends BaseOpenUrlProcessor
  {
    ...
    public boolean isSupported(@NonNull Intent intent)
    {
      ...
      return (scheme.equals("mapsme") || scheme.equals("mapsrahal")) && "lead".equals(host);
    }
  }
  ...
  {
    private static final String ACTION_SHOW_ON_MAP = "com.mapsrahal.maps.pro.action.SHOW_ON_MAP";
  ...
  {
    private static final String ACTION_BUILD_ROUTE = "com.mapsrahal.maps.pro.action.BUILD_ROUTE";
    ...
    public boolean run(@NonNull MwmActivity target)
    {
      ...
      switch (result)
      {
        case ParsedUrlMwmRequest.RESULT_INCORRECT:
          // TODO: Kernel recognizes "mapsme://", "mwm://" and "mapsrahal://" schemas only!!!
