...
public class UserMessage {
    ...
    public UserMessage(int fUserId, int tUserId, int mFlag, double tripId, double distance, String price, String mTripTime, String phone, String name, String fAddress, String tAddress, String note, double fLat, double fLng, double tLat, double tLng) {
