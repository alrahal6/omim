...
import com.mapsrahal.maps.Framework.MapObjectListener;
import com.mapsrahal.maps.activity.CustomNavigateUpListener;
import com.mapsrahal.maps.ads.LikesManager;
import com.mapsrahal.maps.api.ParsedMwmRequest;
import com.mapsrahal.maps.auth.PassportAuthDialogFragment;
import com.mapsrahal.maps.background.AppBackgroundTracker;
import com.mapsrahal.maps.background.NotificationCandidate;
...
import com.mapsrahal.maps.bookmarks.data.CatalogCustomProperty;
...
import com.mapsrahal.maps.dialog.DefaultConfirmationAlertDialog;
import com.mapsrahal.maps.dialog.DialogUtils;
import com.mapsrahal.maps.discovery.DiscoveryActivity;
import com.mapsrahal.maps.discovery.DiscoveryFragment;
import com.mapsrahal.maps.discovery.ItemType;
import com.mapsrahal.maps.downloader.DownloaderActivity;
import com.mapsrahal.maps.downloader.DownloaderFragment;
import com.mapsrahal.maps.downloader.OnmapDownloader;
import com.mapsrahal.maps.editor.Editor;
import com.mapsrahal.maps.editor.EditorActivity;
import com.mapsrahal.maps.editor.EditorHostFragment;
import com.mapsrahal.maps.editor.FeatureCategoryActivity;
import com.mapsrahal.maps.editor.ReportFragment;
import com.mapsrahal.maps.gallery.Items;
import com.mapsrahal.maps.intent.Factory;
...
import com.mapsrahal.maps.maplayer.MapLayerCompositeController;
import com.mapsrahal.maps.maplayer.Mode;
import com.mapsrahal.maps.maplayer.subway.OnSubwayLayerToggleListener;
import com.mapsrahal.maps.maplayer.subway.SubwayManager;
import com.mapsrahal.maps.maplayer.traffic.OnTrafficLayerToggleListener;
import com.mapsrahal.maps.maplayer.traffic.TrafficManager;
import com.mapsrahal.maps.maplayer.traffic.widget.TrafficButton;
import com.mapsrahal.maps.metrics.UserActionsLogger;
import com.mapsrahal.maps.onboarding.IntroductionDialogFragment;
import com.mapsrahal.maps.onboarding.IntroductionScreenFactory;
import com.mapsrahal.maps.onboarding.OnboardingTip;
import com.mapsrahal.maps.promo.Promo;
import com.mapsrahal.maps.promo.PromoAfterBooking;
import com.mapsrahal.maps.promo.PromoBookingDialogFragment;
import com.mapsrahal.maps.purchase.AdsRemovalActivationCallback;
import com.mapsrahal.maps.purchase.AdsRemovalPurchaseControllerProvider;
import com.mapsrahal.maps.purchase.FailedPurchaseChecker;
import com.mapsrahal.maps.purchase.PurchaseCallback;
import com.mapsrahal.maps.purchase.PurchaseController;
import com.mapsrahal.maps.purchase.PurchaseFactory;
...
import com.mapsrahal.maps.routing.RoutingBottomMenuListener;
import com.mapsrahal.maps.routing.RoutingController;
import com.mapsrahal.maps.routing.RoutingErrorDialogFragment;
import com.mapsrahal.maps.routing.RoutingOptions;
import com.mapsrahal.maps.routing.RoutingPlanFragment;
import com.mapsrahal.maps.routing.RoutingPlanInplaceController;
import com.mapsrahal.maps.search.BookingFilterParams;
import com.mapsrahal.maps.search.FilterActivity;
import com.mapsrahal.maps.search.FloatingSearchToolbarController;
import com.mapsrahal.maps.search.HotelsFilter;
import com.mapsrahal.maps.search.NativeSearchListener;
...
import com.mapsrahal.maps.search.SearchFragment;
import com.mapsrahal.maps.search.SearchResult;
import com.mapsrahal.maps.settings.DrivingOptionsActivity;
import com.mapsrahal.maps.settings.RoadType;
import com.mapsrahal.maps.settings.SettingsActivity;
import com.mapsrahal.maps.settings.StoragePathManager;
import com.mapsrahal.maps.settings.UnitLocale;
...
import com.mapsrahal.maps.tips.Tutorial;
import com.mapsrahal.maps.tips.TutorialAction;
import com.mapsrahal.maps.widget.FadeView;
...
import com.mapsrahal.maps.widget.placepage.BottomSheetPlacePageController;
import com.mapsrahal.maps.widget.placepage.PlacePageController;
import com.mapsrahal.maps.widget.placepage.RoutingModeListener;
import com.mapsrahal.util.Counters;
import com.mapsrahal.util.InputUtils;
...
import com.mapsrahal.util.sharing.ShareOption;
import com.mapsrahal.util.sharing.SharingHelper;
                                 ...
                                 MaterialTapTargetPrompt.PromptStateChangeListener
{
  ...
  {
    com.mapsrahal.maps.dialog.AlertDialog dialog =
        new com.mapsrahal.maps.dialog.AlertDialog.Builder()
            ...
            .setDialogViewStrategyType(com.mapsrahal.maps.dialog.AlertDialog.DialogViewStrategyType.CONFIRMATION_DIALOG)
            ...
            .setFragManagerStrategyType(com.mapsrahal.maps.dialog.AlertDialog
