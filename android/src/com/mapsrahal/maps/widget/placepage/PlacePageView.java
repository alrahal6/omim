...
import com.mapsrahal.maps.ads.LocalAdInfo;
import com.mapsrahal.maps.api.ParsedMwmRequest;
import com.mapsrahal.maps.base.Detachable;
import com.mapsrahal.maps.bookmarks.data.Bookmark;
import com.mapsrahal.maps.bookmarks.data.BookmarkManager;
import com.mapsrahal.maps.bookmarks.data.DistanceAndAzimut;
import com.mapsrahal.maps.bookmarks.data.MapObject;
import com.mapsrahal.maps.bookmarks.data.Metadata;
import com.mapsrahal.maps.bookmarks.data.RoadWarningMarkType;
import com.mapsrahal.maps.downloader.CountryItem;
import com.mapsrahal.maps.downloader.DownloaderStatusIcon;
import com.mapsrahal.maps.downloader.MapManager;
import com.mapsrahal.maps.editor.Editor;
import com.mapsrahal.maps.editor.OpeningHours;
import com.mapsrahal.maps.editor.data.TimeFormatUtils;
import com.mapsrahal.maps.editor.data.Timetable;
import com.mapsrahal.maps.gallery.Constants;
import com.mapsrahal.maps.gallery.FullScreenGalleryActivity;
import com.mapsrahal.maps.gallery.GalleryActivity;
import com.mapsrahal.maps.location.LocationHelper;
import com.mapsrahal.maps.metrics.UserActionsLogger;
import com.mapsrahal.maps.promo.CatalogPromoController;
import com.mapsrahal.maps.promo.PromoCityGallery;
import com.mapsrahal.maps.promo.PromoEntity;
import com.mapsrahal.maps.review.Review;
import com.mapsrahal.maps.routing.RoutingController;
import com.mapsrahal.maps.search.FilterUtils;
import com.mapsrahal.maps.search.HotelsFilter;
import com.mapsrahal.maps.search.Popularity;
import com.mapsrahal.maps.settings.RoadType;
import com.mapsrahal.maps.taxi.TaxiType;
import com.mapsrahal.maps.ugc.Impress;
import com.mapsrahal.maps.ugc.UGCController;
import com.mapsrahal.maps.widget.ArrowView;
import com.mapsrahal.maps.widget.LineCountTextView;
import com.mapsrahal.maps.widget.RatingView;
import com.mapsrahal.maps.widget.recycler.ItemDecoratorFactory;
import com.mapsrahal.maps.widget.recycler.RecyclerClickListener;
import com.mapsrahal.util.ConnectionState;
import com.mapsrahal.util.Graphics;
import com.mapsrahal.util.NetworkPolicy;
import com.mapsrahal.util.SponsoredLinks;
import com.mapsrahal.util.StringUtils;
...
import static com.mapsrahal.maps.widget.placepage.PlacePageButtons.Item.BOOKING;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_HOTEL_DESCRIPTION_LAND;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_HOTEL_FACILITIES;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_HOTEL_GALLERY_OPEN;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_HOTEL_REVIEWS_LAND;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_SPONSORED_ACTION;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_SPONSORED_DETAILS;
import static com.mapsrahal.util.statistics.Statistics.EventName.PP_SPONSORED_OPENTABLE;
...

{
  ...
  @NonNull
  private final com.mapsrahal.maps.widget.placepage.GalleryAdapter mGalleryAdapter;
  @NonNull
  ...
  public PlacePageView(Context context, AttributeSet attrs, int defStyleAttr)
  {
    ...
    mGalleryAdapter = new com.mapsrahal.maps.widget.placepage.GalleryAdapter(context);
  ...
  public void onItemClick(View v, int position)
  {
    ...
    if (position == com.mapsrahal.maps.widget.placepage.GalleryAdapter.MAX_COUNT - 1
        && mGalleryAdapter.getItems().size() > com.mapsrahal.maps.widget.placepage.GalleryAdapter.MAX_COUNT)
    {
