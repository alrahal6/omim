...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button mChooseFile,mTakePhoto,mNewVehicle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTakePhoto = findViewById(R.id.take_image);
        mNewVehicle = findViewById(R.id.vehicle_info);
        ...
        if (resultCode == Activity.RESULT_OK)
            switch (requestCode) {
                ...
                case CAMERA_REQUEST_CODE:
                    mImageView.setImageURI(Uri.parse(cameraFilePath));
                    break;
            }
    }
