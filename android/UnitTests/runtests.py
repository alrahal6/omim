...
The script removes all the apps whose ids contain "mapsrahal", and cleans up 
...
# mapsrahal_paths=["storage/sdcard0/MapsWithMe", "mnt/sdcard/MapsWithMe", 
#                   "/mnt/shell/emulated/0/MapsWithMe", "/mnt/sdcard/MapsWithMe"]


ACTIVITY_NAME = "com.mapsrahal.maps.unittests.debug/com.mapsrahal.maps.unittests.AllTestsActivity"

APP_ID = "com.mapsrahal.maps.unittests.debug"
...
def packages(serial):
    packs = adb("pm list packages | grep mapsrahal", serial=serial, shell=True)
