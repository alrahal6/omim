...
private:
  void Init(JNIEnv * env)
  {
    ...
    m_class = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/bookmarks/data/FeatureId");
...
private:
  ...
  void Init(JNIEnv * env)
  {
    ...
    m_ugcClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/ugc/UGC");
    m_ugcCtor = jni::GetConstructorID(
        env, m_ugcClass,
        "([Lcom/mapsrahal/maps/ugc/UGC$Rating;F[Lcom/mapsrahal/maps/ugc/UGC$Review;I)V");
    m_ugcReceived = jni::GetStaticMethodID(
        env, m_ugcClass, "onUGCReceived",
        "(Lcom/mapsrahal/maps/ugc/UGC;Lcom/mapsrahal/maps/ugc/UGCUpdate;ILjava/lang/String;)V");

    m_ratingCtor = jni::GetConstructorID(env, g_ratingClazz, "(Ljava/lang/String;F)V");

    m_reviewClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/ugc/UGC$Review");
    m_reviewCtor =
        jni::GetConstructorID(env, m_reviewClass, "(Ljava/lang/String;Ljava/lang/String;JFI)V");

    m_ugcUpdateClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/ugc/UGCUpdate");
    m_ugcUpdateCtor = jni::GetConstructorID(
        env, m_ugcUpdateClass, "([Lcom/mapsrahal/maps/ugc/UGC$Rating;Ljava/lang/String;"
                                 "JLjava/lang/String;Ljava/lang/String;)V");
    m_ratingArrayFieldId = env->GetFieldID(m_ugcUpdateClass, "mRatings", "[Lcom/mapsrahal/maps/ugc/UGC$Rating;");
...
extern "C" {
JNIEXPORT
void JNICALL Java_com_mapsrahal_maps_ugc_UGC_nativeRequestUGC(JNIEnv * env, jclass /* clazz */,
                                                               jobject featureId)
{
...
JNIEXPORT
void JNICALL Java_com_mapsrahal_maps_ugc_UGC_nativeSetUGCUpdate(JNIEnv * env, jclass /* clazz */,
                                                                 jobject featureId,
                                                                 jobject ugcUpdate)
{
  auto const fid = g_builder.Build(env, featureId);
...
JNIEXPORT
void JNICALL Java_com_mapsrahal_maps_ugc_UGC_nativeUploadUGC(JNIEnv * env, jclass /* clazz */)
{
  g_framework->UploadUGC();
}

JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_ugc_UGC_nativeToImpress(JNIEnv  *env, jclass type, jfloat rating)
{
  return JavaBridge::ToImpress(static_cast<float>(rating));
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_ugc_UGC_nativeFormatRating(JNIEnv  *env, jclass type, jfloat rating)
{
