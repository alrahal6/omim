...
void PrepareClassRefs(JNIEnv * env)
{
  ...
  g_countryItemClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/downloader/CountryItem");
}
...
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetRoot(JNIEnv * env, jclass clazz)
{
...
Java_com_mapsrahal_maps_downloader_MapManager_nativeMoveFile(JNIEnv * env, jclass clazz, jstring oldFile, jstring newFile)
{
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeHasSpaceToDownloadAmount(JNIEnv * env, jclass clazz, jlong bytes)
{
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeHasSpaceToDownloadCountry(JNIEnv * env, jclass clazz, jstring root)
{
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeHasSpaceToUpdate(JNIEnv * env, jclass clazz, jstring root)
{
...
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetDownloadedCount(JNIEnv * env, jclass clazz)
{
...
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetUpdateInfo(JNIEnv * env, jclass clazz, jstring root)
{
  Storage::UpdateInfo info;
  if (!GetStorage().GetUpdateInfo(GetRootId(env, root), info))
    return nullptr;

  static jclass const infoClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/downloader/UpdateInfo");
...
Java_com_mapsrahal_maps_downloader_MapManager_nativeListItems(JNIEnv * env, jclass clazz, jstring parent, jdouble lat, jdouble lon, jboolean hasLocation, jboolean myMapsMode, jobject result)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetAttributes(JNIEnv * env, jclass clazz, jobject item)
{
  PrepareClassRefs(env);
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetStatus(JNIEnv * env, jclass clazz, jstring root)
{
  NodeStatuses ns;
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetError(JNIEnv * env, jclass clazz, jstring root)
{
  NodeStatuses ns;
  GetStorage().GetNodeStatuses(jni::ToNativeString(env, root), ns);
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetName(JNIEnv * env, jclass clazz, jstring root)
{
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeFindCountry(JNIEnv * env, jclass clazz, jdouble lat, jdouble lon)
{
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeIsDownloading(JNIEnv * env, jclass clazz)
{
  return static_cast<jboolean>(GetStorage().IsDownloadInProgress());
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetCurrentDownloadingCountryId(JNIEnv * env, jclass)
{
...
static void EndBatchingCallbacks(JNIEnv * env)
{
  ...
  for (auto & key : g_batchedCallbackData)
  {
    ...
    for (TBatchedData const & dataItem : key.second)
    {
      ...
      static jclass batchDataClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/downloader/MapManager$StorageCallbackData");
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeDownload(JNIEnv * env, jclass clazz, jstring root)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeRetry(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeUpdate(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeCancel(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeDelete(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeSubscribe(JNIEnv * env, jclass clazz, jobject listener)
{
  PrepareClassRefs(env);
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeUnsubscribe(JNIEnv * env, jclass clazz, jint slot)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeSubscribeOnCountryChanged(JNIEnv * env, jclass clazz, jobject listener)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeUnsubscribeOnCountryChanged(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeHasUnsavedEditorChanges(JNIEnv * env, jclass clazz, jstring root)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetPathTo(JNIEnv * env, jclass clazz, jstring root, jobject result)
{
  CountriesVec path;
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetOverallProgress(JNIEnv * env, jclass clazz, jobjectArray jcountries)
{
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeIsAutoretryFailed(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeIsDownloadOn3gEnabled(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeEnableDownloadOn3g(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_downloader_MapManager_nativeGetSelectedCountry(JNIEnv * env, jclass clazz)
{
