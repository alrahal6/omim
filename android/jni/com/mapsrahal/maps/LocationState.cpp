...
Java_com_mapsrahal_maps_location_LocationState_nativeSwitchToNextMode(JNIEnv * env, jclass clazz)
{
...
Java_com_mapsrahal_maps_location_LocationState_nativeGetMode(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_location_LocationState_nativeSetListener(JNIEnv * env, jclass clazz,
                                                                  jobject listener)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_location_LocationState_nativeRemoveListener(JNIEnv * env, jclass clazz)
{
  g_framework->SetMyPositionModeListener(location::TMyPositionModeChanged());
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_location_LocationState_nativeSetLocationPendingTimeoutListener(
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_location_LocationState_nativeRemoveLocationPendingTimeoutListener(
  JNIEnv * env, jclass)
{
