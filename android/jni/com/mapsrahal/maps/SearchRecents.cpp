...
extern "C"
{
  ...
  Java_com_mapsrahal_maps_search_SearchRecents_nativeGetList(JNIEnv * env, jclass thiz, jobject result)
  {
  ...
  JNIEXPORT void JNICALL
  Java_com_mapsrahal_maps_search_SearchRecents_nativeAdd(JNIEnv * env, jclass thiz, jstring locale, jstring query)
  {
  ...
  JNIEXPORT void JNICALL
  Java_com_mapsrahal_maps_search_SearchRecents_nativeClear(JNIEnv * env, jclass thiz)
  {
