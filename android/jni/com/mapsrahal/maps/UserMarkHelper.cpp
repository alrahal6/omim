...
jobject CreatePopularity(JNIEnv * env, place_page::Info const & info)
{
  static jclass const popularityClass =
    jni::GetGlobalClassRef(env, "com/mapsrahal/maps/search/Popularity");
                        ...
                        RoadWarningMarkType roadWarningMarkType, jobjectArray jrawTypes)
{
  ...
  static jmethodID const ctorId = jni::GetConstructorID(
      ...
      "(Lcom/mapsrahal/maps/bookmarks/data/FeatureId;ILjava/lang/String;Ljava/lang/"
      "String;Ljava/lang/String;Ljava/lang/String;DDLjava/lang/"
      "String;[Lcom/mapsrahal/maps/ads/Banner;[ILjava/lang/String;"
      "Lcom/mapsrahal/maps/ads/LocalAdInfo;"
      "Lcom/mapsrahal/maps/routing/RoutePointInfo;IZZZ[Lcom/mapsrahal/maps/ugc/UGC$Rating;"
      "Lcom/mapsrahal/maps/search/HotelsFilter$HotelType;ILcom/mapsrahal/maps/search/Popularity;"
...
jobject CreateMapObject(JNIEnv * env, place_page::Info const & info)
{
  ...
  if (info.IsBookmark())
  {
    ...
    //                 @Nullable HotelsFilter.HotelType hotelType,
    //                 @PriceFilterView.PriceDef int priceRate,
    //                 @NotNull com.mapsrahal.maps.search.Popularity entity
    //                 @NotNull String description)
    static jmethodID const ctorId =
        jni::GetConstructorID(env, g_bookmarkClazz,
                              "(Lcom/mapsrahal/maps/bookmarks/data/FeatureId;JJLjava/lang/String;"
                              "Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;"
                              "[Lcom/mapsrahal/maps/ads/Banner;[ILjava/lang/String;"
                              "Lcom/mapsrahal/maps/ads/LocalAdInfo;"
                              "Lcom/mapsrahal/maps/routing/RoutePointInfo;"
                              "IZZZ[Lcom/mapsrahal/maps/ugc/UGC$Rating;"
                              "Lcom/mapsrahal/maps/search/HotelsFilter$HotelType;"
                              "ILcom/mapsrahal/maps/search/Popularity;Ljava/lang/String;"
                              "[Ljava/lang/String;)V");
    // public FeatureId(@NonNull String mwmName, long mwmVersion, int featureIndex)
    static jmethodID const featureCtorId =
        jni::GetConstructorID(env, g_featureIdClazz, "(Ljava/lang/String;JI)V");
...
{
  static jclass const localAdInfoClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/ads/LocalAdInfo");
...
{
  static jclass const clazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/routing/RoutePointInfo");
