...
extern "C"
{
  ...
  Java_com_mapsrahal_maps_MwmApplication_nativeInitPlatform(JNIEnv * env, jobject thiz,
  ...
  JNIEXPORT void JNICALL
  Java_com_mapsrahal_maps_MwmApplication_nativeInitFramework(JNIEnv * env, jclass clazz)
  {
    if (!g_framework)
  ...
  JNIEXPORT void JNICALL
  Java_com_mapsrahal_maps_MwmApplication_nativeProcessTask(JNIEnv * env, jclass clazz, jlong taskPointer)
  {
  ...
  JNIEXPORT void JNICALL
  Java_com_mapsrahal_maps_MwmApplication_nativeAddLocalization(JNIEnv * env, jclass clazz, jstring name, jstring value)
  {
  ...
  JNIEXPORT void JNICALL
  Java_com_mapsrahal_maps_MwmApplication_nativeOnTransit(JNIEnv *, jclass, jboolean foreground)
  {
