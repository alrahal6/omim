...
void PrepareClassRefs(JNIEnv * env, jclass sponsoredClass)
{
  ...
  g_hotelInfoClass =
      jni::GetGlobalClassRef(env, "com/mapsrahal/maps/widget/placepage/Sponsored$HotelInfo");
  g_facilityTypeClass = jni::GetGlobalClassRef(
      env, "com/mapsrahal/maps/widget/placepage/Sponsored$FacilityType");
  g_nearbyObjectClass = jni::GetGlobalClassRef(
      env, "com/mapsrahal/maps/widget/placepage/Sponsored$NearbyObject");
  g_reviewClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/review/Review");
  g_imageClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/gallery/Image");
  g_priceInfoClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/widget/placepage/HotelPriceInfo");
  ...
  g_hotelInfoConstructor = jni::GetConstructorID(
      ...
      "(Ljava/lang/String;[Lcom/mapsrahal/maps/gallery/Image;[Lcom/mapsrahal/maps/widget/"
      "placepage/Sponsored$FacilityType;[Lcom/mapsrahal/maps/review/Review;[Lcom/mapsrahal/"
  ...
  g_priceCallback =
      jni::GetStaticMethodID(env, g_sponsoredClass, "onPriceReceived",
                             "(Lcom/mapsrahal/maps/widget/placepage/HotelPriceInfo;)V");
  ...
  g_infoCallback = jni::GetStaticMethodID(
      ...
      "(Ljava/lang/String;Lcom/mapsrahal/maps/widget/placepage/Sponsored$HotelInfo;)V");
}
...
JNIEXPORT jobject JNICALL Java_com_mapsrahal_maps_widget_placepage_Sponsored_nativeGetCurrent(
...
JNIEXPORT void JNICALL Java_com_mapsrahal_maps_widget_placepage_Sponsored_nativeRequestPrice(
...
JNIEXPORT void JNICALL Java_com_mapsrahal_maps_widget_placepage_Sponsored_nativeRequestHotelInfo(
