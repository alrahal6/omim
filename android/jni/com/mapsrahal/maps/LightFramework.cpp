...
Java_com_mapsrahal_maps_LightFramework_nativeIsAuthenticated(JNIEnv * env, jclass clazz)
{
...
Java_com_mapsrahal_maps_LightFramework_nativeGetNumberUnsentUGC(JNIEnv * env, jclass clazz)
{
...
Java_com_mapsrahal_maps_LightFramework_nativeMakeFeatureId(JNIEnv * env, jclass clazz,
...
Java_com_mapsrahal_maps_LightFramework_nativeGetLocalAdsFeatures(JNIEnv * env, jclass clazz,
                                                                  ...
                                                                  jint maxCount)
{
  ...
  static jclass const geoFenceFeatureClazz =
          jni::GetGlobalClassRef(env, "com/mapsrahal/maps/geofence/GeoFenceFeature");
  // Java signature : GeoFenceFeature(FeatureId featureId,
  //                                  double latitude, double longitude)
  static jmethodID const geoFenceFeatureConstructor =
          jni::GetConstructorID(env, geoFenceFeatureClazz, "(Lcom/mapsrahal/maps/bookmarks/data/FeatureId;DD)V");
...
Java_com_mapsrahal_maps_LightFramework_nativeLogLocalAdsEvent(JNIEnv * env, jclass clazz,
...
Java_com_mapsrahal_maps_LightFramework_nativeGetNotification(JNIEnv * env, jclass clazz)
{
  ...
  static jclass const candidateId =
      jni::GetGlobalClassRef(env, "com/mapsrahal/maps/background/NotificationCandidate$UgcReview");
