...
#include "com/mapsrahal/maps/discovery/Locals.hpp"
...
void PrepareClassRefs(JNIEnv * env)
{
  ...
  g_discoveryManagerClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/discovery/DiscoveryManager");

  g_discoveryManagerInstanceField = jni::GetStaticFieldID(env, g_discoveryManagerClass, "INSTANCE",
                                                          "Lcom/mapsrahal/maps/discovery/DiscoveryManager;");
...
Java_com_mapsrahal_maps_discovery_DiscoveryManager_nativeDiscover(JNIEnv * env, jclass,
                                                                   jobject params)
{
...
Java_com_mapsrahal_maps_discovery_DiscoveryManager_nativeGetLocalExpertsUrl(JNIEnv * env, jclass)
{
