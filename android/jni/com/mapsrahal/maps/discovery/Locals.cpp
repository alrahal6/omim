...
void PrepareClassRefs(JNIEnv * env)
{
  ...
  g_localsClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/discovery/Locals");
  static jfieldID const localsInstanceField = jni::GetStaticFieldID(env, g_localsClass, "INSTANCE",
                                                                    "Lcom/mapsrahal/maps/discovery/Locals;");
  ...
  g_onLocalsErrorReceivedMethod = jni::GetMethodID(env, g_localsInstance,
                                                   ...
                                                   "(Lcom/mapsrahal/maps/discovery/LocalsError;)V");
  ...
  g_localExpertClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/discovery/LocalExpert");
  ...
  g_localErrorClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/discovery/LocalsError");
...
Java_com_mapsrahal_maps_discovery_Locals_nativeRequestLocals(JNIEnv * env, jclass clazz,
