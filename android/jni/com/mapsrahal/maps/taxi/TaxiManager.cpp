...
void PrepareClassRefs(JNIEnv * env)
{
  ...
  g_taxiManagerClass =
      jni::GetGlobalClassRef(env, "com/mapsrahal/maps/taxi/TaxiManager");
  g_productClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/taxi/TaxiInfo$Product");
  g_productConstructor = jni::GetConstructorID(
      env, g_productClass,
      "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
  g_taxiInfoClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/taxi/TaxiInfo");
  g_taxiInfoErrorClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/taxi/TaxiInfoError");
  g_taxiManagerInstanceField = jni::GetStaticFieldID(
      env, g_taxiManagerClass, "INSTANCE", "Lcom/mapsrahal/maps/taxi/TaxiManager;");
  ...
  g_taxiInfoCallbackMethod =
      jni::GetMethodID(env, g_taxiManagerInstance, "onTaxiProvidersReceived",
                       "([Lcom/mapsrahal/maps/taxi/TaxiInfo;)V");
  g_taxiErrorCallbackMethod = jni::GetMethodID(env, g_taxiManagerInstance,
                                               "onTaxiErrorsReceived", "([Lcom/mapsrahal/maps/taxi/TaxiInfoError;)V");
  g_taxiInfoConstructor = jni::GetConstructorID(env, g_taxiInfoClass,
                                                "(I[Lcom/mapsrahal/maps/taxi/TaxiInfo$Product;)V");
  g_taxiInfoErrorConstructor = jni::GetConstructorID(env, g_taxiInfoErrorClass,
                                                  "(ILjava/lang/String;)V");
  g_taxiLinksClass = jni::GetGlobalClassRef(env, "com/mapsrahal/util/SponsoredLinks");
...
JNIEXPORT void JNICALL Java_com_mapsrahal_maps_taxi_TaxiManager_nativeRequestTaxiProducts(
...
JNIEXPORT jobject JNICALL Java_com_mapsrahal_maps_taxi_TaxiManager_nativeGetTaxiLinks(
