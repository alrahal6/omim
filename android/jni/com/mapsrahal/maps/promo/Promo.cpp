#include "com/mapsrahal/maps/promo/Promo.hpp"
...
void PrepareClassRefs(JNIEnv * env)
{
  ...
  g_galleryClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/promo/PromoCityGallery");
  g_galleryConstructor =
      jni::GetConstructorID(env, g_galleryClass,
                            "([Lcom/mapsrahal/maps/promo/PromoCityGallery$Item;"
                            "Ljava/lang/String;Ljava/lang/String;)V");
  g_itemClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/promo/PromoCityGallery$Item");
  g_itemConstructor =
      jni::GetConstructorID(env, g_itemClass,
                            "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;"
                            "Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;"
                            "Lcom/mapsrahal/maps/promo/PromoCityGallery$Place;"
                            "Lcom/mapsrahal/maps/promo/PromoCityGallery$Author;"
                            "Lcom/mapsrahal/maps/promo/PromoCityGallery$LuxCategory;)V");
  g_placeClass =
    jni::GetGlobalClassRef(env, "com/mapsrahal/maps/promo/PromoCityGallery$Place");
  g_placeConstructor =
    jni::GetConstructorID(env, g_placeClass, "(Ljava/lang/String;Ljava/lang/String;)V");
  g_authorClass =
      jni::GetGlobalClassRef(env, "com/mapsrahal/maps/promo/PromoCityGallery$Author");
  g_authorConstructor =
      jni::GetConstructorID(env, g_authorClass, "(Ljava/lang/String;Ljava/lang/String;)V");
  g_categoryClass =
      jni::GetGlobalClassRef(env, "com/mapsrahal/maps/promo/PromoCityGallery$LuxCategory");
  g_categoryConstructor =
      jni::GetConstructorID(env, g_categoryClass, "(Ljava/lang/String;Ljava/lang/String;)V");

  g_promoClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/promo/Promo");
  g_promoInstanceField =
      jni::GetStaticFieldID(env, g_promoClass, "INSTANCE", "Lcom/mapsrahal/maps/promo/Promo;");
  ...
  g_onGalleryReceived = jni::GetMethodID(env, promoInstance, "onCityGalleryReceived",
                                         "(Lcom/mapsrahal/maps/promo/PromoCityGallery;)V");
  g_onErrorReceived = jni::GetMethodID(env, promoInstance, "onErrorReceived", "()V");
  g_afterBooking = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/promo/PromoAfterBooking");
...
Java_com_mapsrahal_maps_promo_Promo_nativeRequestCityGallery(JNIEnv * env, jclass,
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_promo_Promo_nativeRequestPoiGallery(JNIEnv * env, jclass,
                                                             jobject policy, jdouble lat,
...
Java_com_mapsrahal_maps_promo_Promo_nativeGetPromoAfterBooking(JNIEnv * env, jclass,
                                                                jobject policy)
{
  PrepareClassRefs(env);
...
Java_com_mapsrahal_maps_promo_Promo_nativeGetCityUrl(JNIEnv * env, jclass, jobject policy,
