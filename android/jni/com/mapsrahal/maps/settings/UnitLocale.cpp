...
extern "C"
{
  ...
  Java_com_mapsrahal_maps_settings_UnitLocale_setCurrentUnits(JNIEnv * env, jobject thiz, jint units)
  {
  ...
  Java_com_mapsrahal_maps_settings_UnitLocale_getCurrentUnits(JNIEnv * env, jobject thiz)
  {
