...
Java_com_mapsrahal_maps_editor_OsmOAuth_nativeAuthWithPassword(JNIEnv * env, jclass clazz,
...
JNIEXPORT jobjectArray JNICALL
Java_com_mapsrahal_maps_editor_OsmOAuth_nativeAuthWithWebviewToken(JNIEnv * env, jclass clazz,
...
JNIEXPORT jobjectArray JNICALL
Java_com_mapsrahal_maps_editor_OsmOAuth_nativeGetFacebookAuthUrl(JNIEnv * env, jclass clazz)
{
  try
  {
...
JNIEXPORT jobjectArray JNICALL
Java_com_mapsrahal_maps_editor_OsmOAuth_nativeGetGoogleAuthUrl(JNIEnv * env, jclass clazz)
{
  try
  {
...
Java_com_mapsrahal_maps_editor_OsmOAuth_nativeGetOsmUsername(JNIEnv * env, jclass clazz, jstring token, jstring secret)
{
  try
  {
...
Java_com_mapsrahal_maps_editor_OsmOAuth_nativeUpdateOsmUserStats(JNIEnv * env, jclass clazz, jstring jUsername, jboolean forceUpdate)
{
  static jclass const statsClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/editor/data/UserStats");
  ...
  static jmethodID const listenerId = jni::GetStaticMethodID(env, osmAuthClazz, "onUserStatsUpdated", "(Lcom/mapsrahal/maps/editor/data/UserStats;)V");
