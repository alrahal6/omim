...
extern "C"
{
  ...
  Java_com_mapsrahal_maps_DownloadResourcesLegacyActivity_nativeGetBytesToDownload(JNIEnv * env, jclass clazz)
  {
    // clear all
  ...
  JNIEXPORT jint JNICALL
  Java_com_mapsrahal_maps_DownloadResourcesLegacyActivity_nativeStartNextFileDownload(JNIEnv * env, jclass clazz, jobject listener)
  {
  ...
  Java_com_mapsrahal_maps_DownloadResourcesLegacyActivity_nativeCancelCurrentFile(JNIEnv * env, jclass clazz)
  {
