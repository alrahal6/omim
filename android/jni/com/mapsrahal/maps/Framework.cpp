...
#include "com/mapsrahal/maps/UserMarkHelper.hpp"
#include "com/mapsrahal/opengl/androidoglcontextfactory.hpp"
#include "com/mapsrahal/platform/Platform.hpp"
#include "com/mapsrahal/util/NetworkPolicy.hpp"
#include "com/mapsrahal/vulkan/android_vulkan_context_factory.hpp"
...
//============ GLUE CODE for com.mapsrahal.maps.Framework class =============//
/*            ____
 *          _ |||| _
 *          \\    //
 *           \\  //
...
Java_com_mapsrahal_maps_Framework_nativeGetAddress(JNIEnv * env, jclass clazz, jdouble lat, jdouble lon)
{
...
Java_com_mapsrahal_maps_Framework_nativeClearApiPoints(JNIEnv * env, jclass clazz)
{
  frm()->GetBookmarkManager().GetEditSession().ClearGroup(UserMark::Type::API);
}

JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeParseAndSetApiUrl(JNIEnv * env, jclass clazz, jstring url)
{
  return static_cast<jint>(frm()->ParseAndSetApiURL(jni::ToNativeString(env, url)));
}

JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetParsedRoutingData(JNIEnv * env, jclass clazz)
{
  using namespace url_scheme;
  static jclass const pointClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/api/RoutePoint");
  ...
  static jclass const routeDataClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/api/ParsedRoutingData");
  // Java signature : ParsedRoutingData(RoutePoint[] points, int routerType) {
  static jmethodID const routeDataConstructor = jni::GetConstructorID(env, routeDataClazz, "([Lcom/mapsrahal/maps/api/RoutePoint;I)V");
...
JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetParsedSearchRequest(JNIEnv * env, jclass clazz)
{
  using namespace url_scheme;
  static jclass const cl = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/api/ParsedSearchRequest");
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetMapObjectListener(JNIEnv * env, jclass clazz, jobject jListener)
{
  ...
  jmethodID const activatedId = jni::GetMethodID(env, g_mapObjectListener, "onMapObjectActivated",
                                                 "(Lcom/mapsrahal/maps/bookmarks/data/MapObject;)V");
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeRemoveMapObjectListener(JNIEnv * env, jclass)
{
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetGe0Url(JNIEnv * env, jclass, jdouble lat, jdouble lon, jdouble zoomLevel, jstring name)
{
  ::Framework * fr = frm();
...
JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetDistanceAndAzimuth(
    JNIEnv * env, jclass, jdouble merX, jdouble merY, jdouble cLat, jdouble cLon, jdouble north)
{
  ...
  static jclass const daClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/bookmarks/data/DistanceAndAzimut");
...
JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetDistanceAndAzimuthFromLatLon(
    JNIEnv * env, jclass clazz, jdouble lat, jdouble lon, jdouble cLat, jdouble cLon, jdouble north)
{
  ...
  return Java_com_mapsrahal_maps_Framework_nativeGetDistanceAndAzimuth(env, clazz, merX, merY, cLat, cLon, north);
}

JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeFormatLatLon(JNIEnv * env, jclass, jdouble lat, jdouble lon, jboolean useDMSFormat)
{
...
Java_com_mapsrahal_maps_Framework_nativeFormatLatLonToArr(JNIEnv * env, jclass, jdouble lat, jdouble lon, jboolean useDMSFormat)
{
  string slat, slon;
  if (useDMSFormat)
...
{
    return jni::ToJavaString(env, "http://carpoolapi.com/amgad/module/");
  //return jni::ToJavaString(env, "http://207.180.241.110/amgad/module/");
...
{
    return jni::ToJavaString(env, "ws://carpoolapi.com:9005/");
    //return jni::ToJavaString(env, "ws://207.180.241.110:9005/");
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetBaseUrlLocal(JNIEnv * env, jclass)
{
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetWsUrlLocal(JNIEnv * env, jclass)
{
  //return jni::ToJavaString(env, "ws://alrahal.info:4001/");
  return jni::ToJavaString(env, "ws://192.168.43.214:9005/");
  //return jni::ToJavaString(env, "ws://192.168.43.214:3002/x");
  //return jni::ToJavaString(env, "ws://3.18.30.74:3003/x");
  //return jni::ToJavaString(env, "ws://alrahal.info:3003/x");
}
...
JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeFormatSpeed(JNIEnv * env, jclass, jdouble speed)
{
  return jni::ToJavaString(env, measurement_utils::FormatSpeedWithDeviceUnits(speed));
}

JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetOutdatedCountriesString(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, g_framework->GetOutdatedCountriesString());
}

JNIEXPORT jobjectArray JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetOutdatedCountries(JNIEnv * env, jclass)
{
  vector<Country const *> countries;
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeToDoAfterUpdate(JNIEnv * env, jclass)
{
  return g_framework->ToDoAfterUpdate();
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsDataVersionChanged(JNIEnv * env, jclass)
{
  return frm()->IsDataVersionUpdated() ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeUpdateSavedDataVersion(JNIEnv * env, jclass)
{
  frm()->UpdateSavedDataVersion();
}

JNIEXPORT jlong JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetDataVersion(JNIEnv * env, jclass)
{
  return frm()->GetCurrentDataVersion();
}

JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetDrawScale(JNIEnv * env, jclass)
{
  return static_cast<jint>(frm()->GetDrawScale());
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativePokeSearchInViewport(JNIEnv * env, jclass)
{
  frm()->PokeSearchInViewport();
}

JNIEXPORT jdoubleArray JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetScreenRectCenter(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeShowTrackRect(JNIEnv * env, jclass, jlong track)
{
  frm()->ShowTrack(static_cast<kml::TrackId>(track));
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetBookmarkDir(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, GetPlatform().SettingsDir().c_str());
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetWritableDir(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, GetPlatform().WritableDir().c_str());
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetSettingsDir(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, GetPlatform().SettingsDir().c_str());
}

JNIEXPORT jobjectArray JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetMovableFilesExts(JNIEnv * env, jclass)
{
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetBookmarksExt(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, BOOKMARKS_FILE_EXTENSION);
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetWritableDir(JNIEnv * env, jclass, jstring jNewPath)
{
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsRoutingActive(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().IsRoutingActive();
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsRouteBuilding(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().IsRouteBuilding();
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsRouteBuilt(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().IsRouteBuilt();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeCloseRouting(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().CloseRouting(true /* remove route points */);
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeBuildRoute(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().BuildRoute();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeRemoveRoute(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().RemoveRoute(false /* deactivateFollowing */);
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeFollowRoute(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().FollowRoute();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeDisableFollowing(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().DisableFollowMode();
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetUserAgent(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, GetPlatform().GetAppUserAgent());
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetDeviceId(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, web_api::DeviceId());
}

JNIEXPORT jobjectArray JNICALL
Java_com_mapsrahal_maps_Framework_nativeGenerateNotifications(JNIEnv * env, jclass)
{
  ::Framework * fr = frm();
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetSpeedCamManagerMode(JNIEnv * env, jclass, jint mode)
{
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetSpeedCamManagerMode(JNIEnv * env, jclass)
{
  return static_cast<jint>(frm()->GetRoutingManager().GetSpeedCamManager().GetMode());
}

JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetRouteFollowingInfo(JNIEnv * env, jclass)
{
  ::Framework * fr = frm();
  if (!fr->GetRoutingManager().IsRoutingActive())
    return nullptr;
  ...
  static jclass const klass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/routing/RoutingInfo");
  ...
  static jmethodID const ctorRouteInfoID = jni::GetConstructorID(env, klass,
                                               ...
                                               "[Lcom/mapsrahal/maps/routing/SingleLaneInfo;ZZ)V");

  vector<routing::FollowingInfo::SingleLaneInfoClient> const & lanes = info.m_lanes;
  jobjectArray jLanes = nullptr;
  if (!lanes.empty())
  {
    static jclass const laneClass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/routing/SingleLaneInfo");
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeDisableAdProvider(JNIEnv * env, jclass, jint type,
                                                           jint place)
{
...
Java_com_mapsrahal_maps_Framework_nativeGenerateRouteAltitudeChartBits(JNIEnv * env, jclass, jint width, jint height, jobject routeAltitudeLimits)
{
  ::Framework * fr = frm();
  ASSERT(fr, ());
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeShowCountry(JNIEnv * env, jclass, jstring countryId, jboolean zoomToDownloadButton)
{
  g_framework->ShowNode(jni::ToNativeString(env, countryId), (bool) zoomToDownloadButton);
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetRoutingListener(JNIEnv * env, jclass, jobject listener)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetRouteProgressListener(JNIEnv * env, jclass, jobject listener)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetRoutingRecommendationListener(JNIEnv * env, jclass,
                                                                          jobject listener)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetRoutingLoadPointsListener(
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeDeactivatePopup(JNIEnv * env, jclass)
{
  return g_framework->DeactivatePopup();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetMapStyle(JNIEnv * env, jclass, jint mapStyle)
{
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetMapStyle(JNIEnv * env, jclass, jint mapStyle)
{
  return g_framework->GetMapStyle();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeMarkMapStyle(JNIEnv * env, jclass, jint mapStyle)
{
  MapStyle const val = static_cast<MapStyle>(mapStyle);
  if (val != g_framework->GetMapStyle())
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetRouter(JNIEnv * env, jclass, jint routerType)
{
  g_framework->GetRoutingManager().SetRouter(static_cast<routing::RouterType>(routerType));
}

JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetRouter(JNIEnv * env, jclass)
{
  return static_cast<jint>(g_framework->GetRoutingManager().GetRouter());
}

JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetLastUsedRouter(JNIEnv * env, jclass)
{
  return static_cast<jint>(g_framework->GetRoutingManager().GetLastUsedRouter());
}

JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetBestRouter(JNIEnv * env, jclass,
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeAddRoutePoint(JNIEnv * env, jclass, jstring title,
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeRemoveRoutePoint(JNIEnv * env, jclass,
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeRemoveIntermediateRoutePoints(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().RemoveIntermediateRoutePoints();
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeCouldAddIntermediatePoint(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().CouldAddIntermediatePoint();
}

JNIEXPORT jobjectArray JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetRoutePoints(JNIEnv * env, jclass)
{
  auto const points = frm()->GetRoutingManager().GetRoutePoints();

  static jclass const pointClazz = jni::GetGlobalClassRef(env,
                                   "com/mapsrahal/maps/routing/RouteMarkData");
...
JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetTransitRouteInfo(JNIEnv * env, jclass)
{
  ...
  static jclass const transitStepClass = jni::GetGlobalClassRef(env,
                                         "com/mapsrahal/maps/routing/TransitStepInfo");
  ...
  static jclass const transitRouteInfoClass = jni::GetGlobalClassRef(env,
                                                                     "com/mapsrahal/maps/routing/TransitRouteInfo");
  ...
  static jmethodID const transitRouteInfoConstructor = jni::GetConstructorID(env, transitRouteInfoClass,
                                                                             ...
                                                                             "Ljava/lang/String;Ljava/lang/String;I"
                                                                             "[Lcom/mapsrahal/maps/routing/TransitStepInfo;)V");
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeRegisterMaps(JNIEnv * env, jclass)
{
  frm()->RegisterAllMaps();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeDeregisterMaps(JNIEnv * env, jclass)
{
  frm()->DeregisterAllMaps();
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsDayTime(JNIEnv * env, jclass, jlong utcTimeSeconds, jdouble lat, jdouble lon)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSet3dMode(JNIEnv * env, jclass, jboolean allow, jboolean allowBuildings)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeGet3dMode(JNIEnv * env, jclass, jobject result)
{
  bool enabled;
  bool buildings;
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetAutoZoomEnabled(JNIEnv * env, jclass, jboolean enabled)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetTransitSchemeEnabled(JNIEnv * env, jclass, jboolean enabled)
{
  frm()->GetTransitManager().EnableTransitSchemeMode(static_cast<bool>(enabled));
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsTransitSchemeEnabled(JNIEnv * env, jclass)
{
  return static_cast<jboolean>(frm()->LoadTransitSchemeEnabled());
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSaveSettingSchemeEnabled(JNIEnv * env, jclass, jboolean enabled)
{
  frm()->SaveTransitSchemeEnabled(static_cast<bool>(enabled));
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetAutoZoomEnabled(JNIEnv *, jclass)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeZoomToPoint(JNIEnv * env, jclass, jdouble lat, jdouble lon, jint zoom, jboolean animate)
{
  g_framework->Scale(m2::PointD(mercator::FromLatLon(lat, lon)), zoom, animate);
}

JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeDeleteBookmarkFromMapObject(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeTurnOnChoosePositionMode(JNIEnv *, jclass, jboolean isBusiness, jboolean applyPosition)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeTurnOffChoosePositionMode(JNIEnv *, jclass)
{
  g_framework->SetChoosePositionMode(false, false, false, m2::PointD());
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsInChoosePositionMode(JNIEnv *, jclass)
{
  return g_framework->GetChoosePositionMode();
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsDownloadedMapAtScreenCenter(JNIEnv *, jclass)
{
  ::Framework * fr = frm();
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetActiveObjectFormattedCuisine(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, g_framework->GetPlacePageInfo().FormatCuisines());
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetVisibleRect(JNIEnv * env, jclass, jint left, jint top, jint right, jint bottom)
{
  frm()->SetVisibleViewport(m2::RectD(left, top, right, bottom));
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsRouteFinished(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().IsRouteFinished();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeLogLocalAdsEvent(JNIEnv * env, jclass, jint type,
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeRunFirstLaunchAnimation(JNIEnv * env, jclass)
{
  frm()->RunFirstLaunchAnimation();
}

JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeOpenRoutePointsTransaction(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().OpenRoutePointsTransaction();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeApplyRoutePointsTransaction(JNIEnv * env, jclass,
                                                                     jint transactionId)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeCancelRoutePointsTransaction(JNIEnv * env, jclass,
                                                                      jint transactionId)
{
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeInvalidRoutePointsTransactionId(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().InvalidRoutePointsTransactionId();
}

JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeHasSavedRoutePoints()
{
  return frm()->GetRoutingManager().HasSavedRoutePoints();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeLoadRoutePoints()
{
  frm()->GetRoutingManager().LoadRoutePoints(g_loadRouteHandler);
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSaveRoutePoints()
{
  frm()->GetRoutingManager().SaveRoutePoints();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeDeleteSavedRoutePoints()
{
  frm()->GetRoutingManager().DeleteSavedRoutePoints();
}

JNIEXPORT jobjectArray JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetSearchBanners(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeAuthenticateUser(JNIEnv * env, jclass, jstring socialToken,
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeIsUserAuthenticated()
{
  return frm()->GetUser().IsAuthenticated();
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetPhoneAuthUrl(JNIEnv * env, jclass, jstring redirectUrl)
{
  return jni::ToJavaString(env, User::GetPhoneAuthUrl(jni::ToNativeString(env, redirectUrl)));
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetPrivacyPolicyLink(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, User::GetPrivacyPolicyLink());
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetTermsOfUseLink(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, User::GetTermsOfUseLink());
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeShowFeatureByLatLon(JNIEnv * env, jclass,
                                                             jdouble lat, jdouble lon)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeShowBookmarkCategory(JNIEnv * env, jclass, jlong cat)
{
  frm()->ShowBookmarkCategory(static_cast<kml::MarkGroupId>(cat));
}

JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetFilterRating(JNIEnv * env, jclass, jfloat rawRating)
{
  return static_cast<jint>(place_page::rating::GetFilterRating(rawRating));
}

JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeMoPubInitializationBannerId(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, ads::Mopub::InitializationBannerId());
}

JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetDownloaderPromoBanner(JNIEnv * env, jclass,
                                                                  jstring mwmId)
{
  static jclass const downloaderPromoBannerClass = jni::GetGlobalClassRef(env,
      "com/mapsrahal/maps/downloader/DownloaderPromoBanner");
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeHasMegafonCategoryBanner(JNIEnv * env, jclass)
{
  auto const & purchase = frm()->GetPurchase();
  if (purchase && purchase->IsSubscriptionActive(SubscriptionType::RemoveAds))
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetMegafonCategoryBannerUrl(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, ads::GetMegafonCategoryBannerUrl());
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeMakeCrash(JNIEnv *env, jclass type)
{
  CHECK(false, ("Diagnostic native crash!"));
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeValidatePurchase(JNIEnv * env, jclass, jstring serverId,
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeStartPurchaseTransaction(JNIEnv * env, jclass,
                                                                  jstring serverId,
                                                                  jstring vendorId)
{
  auto const & purchase = frm()->GetPurchase();
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetPurchaseValidationListener(JNIEnv *, jclass,
                                                                       jobject listener)
{
  auto const & purchase = frm()->GetPurchase();
  if (purchase == nullptr)
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeStartPurchaseTransactionListener(JNIEnv *, jclass,
                                                                          jobject listener)
{
  auto const & purchase = frm()->GetPurchase();
  if (purchase == nullptr)
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeHasActiveSubscription(JNIEnv *, jclass, jint type)
{
  auto const & purchase = frm()->GetPurchase();
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetActiveSubscription(JNIEnv *, jclass, jint type,
                                                               jboolean isActive)
{
  auto const & purchase = frm()->GetPurchase();
  if (purchase == nullptr)
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetCurrentTipIndex(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeBindUser(JNIEnv * env, jclass, jobject listener)
{
...
JNIEXPORT jstring JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetAccessToken(JNIEnv * env, jclass)
{
  auto & user = frm()->GetUser();
...
JNIEXPORT jobject JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetMapObject(JNIEnv * env, jclass,
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetPowerManagerFacility(JNIEnv *, jclass,
...
JNIEXPORT jint JNICALL
Java_com_mapsrahal_maps_Framework_nativeGetPowerManagerScheme(JNIEnv *, jclass)
{
  return static_cast<jint>(frm()->GetPowerManager().GetScheme());
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetPowerManagerScheme(JNIEnv *, jclass, jint schemeType)
{
  frm()->GetPowerManager().SetScheme(static_cast<power_management::Scheme>(schemeType));
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetViewportCenter(JNIEnv *, jclass, jdouble lat,
...
JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeStopLocationFollow(JNIEnv *, jclass)
{
  frm()->StopLocationFollow();
}

JNIEXPORT void JNICALL
Java_com_mapsrahal_maps_Framework_nativeSetSearchViewport(JNIEnv *, jclass, jdouble lat,
...
JNIEXPORT jboolean JNICALL
Java_com_mapsrahal_maps_Framework_nativeNeedToShowCrown(JNIEnv *, jclass)
{
