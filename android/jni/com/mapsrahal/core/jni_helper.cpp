...
JNI_OnLoad(JavaVM * jvm, void *)
{
  ...
  g_mapObjectClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/bookmarks/data/MapObject");
  g_featureIdClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/bookmarks/data/FeatureId");
  g_bookmarkClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/bookmarks/data/Bookmark");
  g_myTrackerClazz = jni::GetGlobalClassRef(env, "com/my/tracker/MyTracker");
  g_httpClientClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/HttpClient");
  g_httpParamsClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/HttpClient$Params");
  g_platformSocketClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/location/PlatformSocket");
  g_utilsClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/Utils");
  g_bannerClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/ads/Banner");
  g_ratingClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/ugc/UGC$Rating");
  g_loggerFactoryClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/log/LoggerFactory");
  g_keyValueClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/KeyValue");
  g_httpUploaderClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/HttpUploader");
  g_httpUploaderResultClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/HttpUploader$Result");
  g_networkPolicyClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/NetworkPolicy");
  g_storageUtilsClazz = jni::GetGlobalClassRef(env, "com/mapsrahal/util/StorageUtils");
...
{
  jclass klass = env->FindClass("com/mapsrahal/maps/bookmarks/data/ParcelablePointD");
  ASSERT ( klass, () );
