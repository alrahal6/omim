...
public:
             ...
             std::string const & pb)
  {
    ...
    static jclass const klass = jni::GetGlobalClassRef(env, "com/mapsrahal/maps/downloader/ChunkTask");
...
Java_com_mapsrahal_maps_downloader_ChunkTask_nativeOnWrite(JNIEnv * env, jclass clazz, jlong httpCallbackID, jlong beg, jbyteArray data, jlong size)
{
...
Java_com_mapsrahal_maps_downloader_ChunkTask_nativeOnFinish(JNIEnv * env, jclass clazz, jlong httpCallbackID, jlong httpCode, jlong beg, jlong end)
{
  downloader::IHttpThreadCallback * cb = reinterpret_cast<downloader::IHttpThreadCallback*>(httpCallbackID);
