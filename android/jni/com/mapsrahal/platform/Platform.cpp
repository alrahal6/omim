...
std::string Platform::GetMemoryInfo() const
{
  ...
  static std::shared_ptr<jobject> classMemLogging = jni::make_global_ref(env->FindClass("com/mapsrahal/util/log/MemLogging"));
...
Platform::EConnectionType Platform::ConnectionStatus()
{
  ...
  static std::shared_ptr<jobject> clazzConnectionState = jni::make_global_ref(env->FindClass("com/mapsrahal/util/ConnectionState"));
...
Platform::ChargingStatus Platform::GetChargingStatus()
{
  ...
  static jclass const clazzBatteryState =
      jni::GetGlobalClassRef(env, "com/mapsrahal/util/BatteryState");
                          ...
                          bool isTablet)
{
  ...
  m_sendAppsFlyerTagsMethod = env->GetMethodID(functorProcessClass, "sendAppsFlyerTags",
      "(Ljava/lang/String;[Lcom/mapsrahal/util/KeyValue;)V");
...
void Platform::AndroidSecureStorage::Init(JNIEnv * env)
{
  ...
  m_secureStorageClass = jni::GetGlobalClassRef(env, "com/mapsrahal/util/SecureStorage");
